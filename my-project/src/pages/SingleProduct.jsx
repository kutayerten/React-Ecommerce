  ...
  return (
   <section>
    ...
    <div className='mt-6 grid gap-y-8 lg:grid-cols-2 lg:gap-x-16'>
      <img src={image} alt={title} className='w-96 h-96 object-cover rounded-lg lg:w-full mx-auto lg:mx-0' />
      <div>
        ...
        <div className="mt-2">
          {colors.map((color)=> {
            return <button key={color}
             type='button'
              className={`badge w-6 h-6 mr-2 ${color === productColor && 'border-4 border-secondary'}`}
          ...
          {/*Cart Button*/}
          <div className='mt-10'>
              <button className='btn btn-secondary btn-md uppercase text-md'
              onClick={addToCart}
              >
                Add To Bag
              </button>
